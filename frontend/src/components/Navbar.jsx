        ...
        <div className="flex items-center gap-6">
            ...
            <div className="group relative">
                ...
                <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4">
                   <div className="flex flex-col gap-s w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded">
            ...
            <p className='abolute right-[-5px] bottoom-[-5px] w-4 text-center loading-4 bg-black text-white aspect-square rounded-full text-[8px] '>10</p>
            </Link>
